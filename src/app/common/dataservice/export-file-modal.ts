...
import { VCenterServerService } from '../../vcenterserver/vcenterserver.service';
...
@Component({
  ...
  template: `
      <div bsModal #childModal="bs-modal" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
            ...
            <div class="modal-content" >
              ...
              <form [formGroup]="exportForm" class="form-horizontal"  >
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-9">
                      <input type="text" class="form-control" placeholder="vcentercollector" formControlName="Author" id="Author">
                      </div>
                    </div>
                    <div class="form-group">
        ...
        providers: [ExportServiceCfg, InfluxServerService, VCenterServerService, DeviceCfgService, TreeView]
})
...
export class ExportFileModal {
  ...
  constructor(builder: FormBuilder, public exportServiceCfg : ExportServiceCfg, public deviceCfgService : DeviceCfgService,
    public influxServerService: InfluxServerService, public hmcServerService: VCenterServerService) {
...
//COMMON
  createStaticForm() {
    this.exportForm = this.builder.group({
      ...
      Author: ['vcentercollector', Validators.required],
      Tags: [''],
...
//Load items functions from services depending on items selected Type
  loadItems(type, filter?) {
    ...
    switch (type) {
      case 'hmcservercfg':
       this.mySubscriber = this.hmcServerService.getVCenterServerItem(filter)
       .subscribe(
       data => {
