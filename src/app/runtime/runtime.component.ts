...
@Component({
  selector: 'runtime',
  providers: [RuntimeService, VCenterServerService],
...
export class RuntimeComponent implements OnDestroy {
  ...
  constructor(public runtimeService: RuntimeService, builder: FormBuilder, private ref: ChangeDetectorRef, public hmcServerService: VCenterServerService) {
    this.editmode = 'list';
    this.reloadData();
  }
