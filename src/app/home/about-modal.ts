      ...
      <div bsModal #childModal="bs-modal" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
          <div class="modal-dialog">
            <div class="modal-content">
              ...
              <h4 class="text-primary"> <b>vcentercollector</b> </h4>
              <span> vCenterCollector is a IBM PSeries Platform Metric collector system </span>
              <div class="text-right">
                <a href="javaScript:void(0);"  (click)="link('https://github.com/toni-moreno/vCenterCollector')" class="text-link"> More info <i class="glyphicon glyphicon-plus-sign"></i></a>
              </div>
              <hr/>
